...
public class SyncSettings extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
  ...
  private static final String KEY_AUTO_SYNC = "sapotero.sed.KEY_AUTO_SYNC";

  private static final String KEY_AUTO_SYNC_INTERVAL = "sapotero.sed.KEY_AUTO_SYNC_INTERVAL";
  ...
  public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
    if (TextUtils.equals(KEY_AUTO_SYNC, key)) {
      if (prefs.getBoolean(key, false)) {
        ...
        ContentResolver.addPeriodicSync(SED.sAccount, SED.AUTHORITY, Bundle.EMPTY, interval);
      } else {
        ContentResolver.removePeriodicSync(SED.sAccount, SED.AUTHORITY, new Bundle());
      }
